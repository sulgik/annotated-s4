...
blog: md
	pandoc docs/header-includes.yaml s4/s4.md  --katex=/usr/local/share/nvm/versions/node/v20.10.0/lib/node_modules/katex/dist/ --output=docs/index.html --to=html5 --css=docs/github.min.css --css=docs/tufte.css --no-highlight --self-contained --metadata pagetitle="The Annotated S4"
#	pandoc docs/header-includes.yaml s4/s4d.md  --katex=/usr/local/share/nvm/versions/node/v20.10.0/lib/node_modules/katex/dist/ --output=docs/s4d.html --to=html5 --css=docs/github.min.css --css=docs/tufte.css --no-highlight --self-contained --metadata pagetitle="The Annotated S4"
	pandoc docs/header-includes.yaml slides.md  --katex=/usr/local/share/nvm/versions/node/v20.10.0/lib/node_modules/katex/dist/ --output=docs/slides.html --to=beamer --css=docs/github.min.css --css=docs/tufte.css --no-highlight --self-contained --metadata pagetitle="The Annotated S4"
